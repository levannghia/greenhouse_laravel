...
use App\Http\Controllers\admin\TypeHouseController;
...
Route::get("/bat-dong-san/{slug}", [ProductSiteController::class, "productCategory"]);
Route::get("/bds/{slug}", [ProductSiteController::class, "getProductBySlug"]);
...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['check.login'])->group(function () {
        ...
        // type_house
        Route::name('admin.type.house.')->prefix('the-loai')->controller(TypeHouseController::class)->group(function () {
            Route::get('/', 'index')->name('index');
        ...
        //News
        Route::name('admin.news.')->prefix('du-an')->controller(NewsController::class)->group(function () {
            Route::get('/', 'index')->name('index');
            Route::get('/add', 'create')->name('add');
            Route::post('/store', 'store')->name('store');
            Route::get('/edit/{id}', 'edit')->name('edit');
