    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="{{route('admin.category.index')}}">Danh mục cấp 1</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{route('admin.type.house.index')}}">Thể loại nhà đất</a></li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-advanced">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="/admin/du-an">Dự án</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/admin/news">Tin
                            tức</a></li>
