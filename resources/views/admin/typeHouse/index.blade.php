        ...
        <div class="card">
            <form>
                <div class="card-body">
                    ...
                    <a href="{{route('admin.type.house.add')}}" class="btn btn-info mb-3"><i
                    ...
                    <div class="row">
                                        ...
                                        @endphp
                                            @foreach ($type as $item)
                                                <tr id="{{$item->id}}" title="Kéo thả chuột để sắp xếp">
                                                    ...
                                                    <td>{{ $i++ }}</td>
                                                    <td><a href="{{ route('admin.type.house.edit', $item->id) }}" title="Chỉnh sửa {{ $item->title }}">{{ $item->title }}</a></td>                                        
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('admin.type.house.edit', $item->id) }}"
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" x-placement="bottom-start"
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item text-danger" delete-all="true" url="/admin/the-loai/delete-all"
    ...
    <script>
        $(document).ready(function() {
            ...
            $("[data-id-status]").click(function() {
                ...
                if (check == true) {
                    $.ajax({
                        url: "/admin/the-loai/status/" + id_status + "/" + 1,
                        type: "GET",
                        data: {
                            id: id_status,
                            _token: _token
                    ...
                    $.ajax({
                        url: "/admin/the-loai/status/" + id_status + "/" + 0,
                        type: "GET",
                        data: {
                            id: id_status,
                            _token: _token
            ...
            $("[data-id-category]").click(function() {
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            swal("Xóa thành công thể loại này", {
                                icon: "success",
                            });
                            $.ajax({
